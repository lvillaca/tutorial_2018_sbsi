...
@Component
public class ClientesPorCarroDataFetcher implements DataFetcher<List<Cliente>> {

    private static final Logger logger = LoggerFactory.getLogger(ClientesPorCarroDataFetcher.class);
